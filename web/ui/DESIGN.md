...
| `#2E6AB4` | 102 | 컴포넌트 채움 |
| `#4A90D9` | 94 | 컴포넌트 채움 |
| `#000000` | 91 | 그림자, 컴포넌트 채움, 테두리, 텍스트 외곽선, 텍스트 입체 |
| `#FFFFFF` | 85 | 그림자, 텍스트 |
...
- `"Lilita One", cursive` — 117곳 · 크기 12/13/15/16/18/19/20/22/23/25/27/28/29/30/32/35/36/38/39/43/44/45/51/58px · 굵기 900/bold/normal
- `"Fredoka One", cursive` — 1곳 · 크기 20px · 굵기 bold
- `Arial, sans-serif` — 1곳 · 크기 18px · 굵기 bold

## 형태 언어 (컴포넌트 139개 기준)

- 도형: `rectangle` 125 · `circle` 9 · `top-round-rect` 4 · `pill` 1
- 모서리 반경(px): 0(10) · 8(1) · 12(96) · 16(27) · 115(5)
- 채움: `none` 97 · `solid` 27 · `radial-gradient` 7 · `linear-gradient` 6 · `conic-gradient` 2
- 테두리 두께(px): 1(2) · 3(1) · 19(4)
- 그림자: 입체(depth-edge) 14 · 외부 7 · 내부 23
- 텍스트 스타일: 외곽선 80 · 입체 39 · 그림자 91
...
- `pop_LevelFail1` — 단색 `rgba(0,0,0,0.3)`
