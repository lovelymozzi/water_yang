...
func _apply_shader_parameters(
	...
	if _cat_material != null:
		...
		_cat_material.set_shader_parameter("line_art_enabled", 1.0 if line_art_texture != null and _mouth_is_open else 0.0)
	...
	if _material_id_2 != null:
		...
		_material_id_2.set_shader_parameter("line_art_enabled", 1.0 if line_art_texture != null and _mouth_is_open else 0.0)
